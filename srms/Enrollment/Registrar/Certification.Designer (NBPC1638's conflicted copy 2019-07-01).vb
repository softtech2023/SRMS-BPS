...
Partial Class frmCertification
    ...
    Private Sub InitializeComponent()
        ...
        Me.cboStudeReport.Items.AddRange(New Object() {"Certificate of Enrollment", "Certificate of GMC", "Clearance", "Report of Grades", "Student's Profile", "Report Card", "Scholastic Record"})
