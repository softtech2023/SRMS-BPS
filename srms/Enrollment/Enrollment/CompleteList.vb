...
Public Class frmCompleteList
    ...
    Private Sub dgstudentsearch_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgstudentsearch.DoubleClick
        Try
            ...
            frmStudeProfile.txtelemSchoolYear.Text = dgstudentsearch.Item(48, dclick).Value
            frmStudeProfile.txtElemGenAve.Text = dgstudentsearch.Item(49, dclick).Value
            frmStudeProfile.mskElemGradDate.Text = dgstudentsearch.Item(50, dclick).Value
            frmStudeProfile.cboEligibility.Text = dgstudentsearch.Item(51, dclick).Value
            frmStudeProfile.txtJHSGenAve.Text = dgstudentsearch.Item(52, dclick).Value
            frmStudeProfile.mskJHSGradDate.Text = dgstudentsearch.Item(53, dclick).Value
            frmStudeProfile.txtElemSchoolID.Text = dgstudentsearch.Item(54, dclick).Value
            frmStudeProfile.txtJHSSchoolID.Text = dgstudentsearch.Item(55, dclick).Value
            frmStudeProfile.txtPEPTRating.Text = dgstudentsearch.Item(56, dclick).Value
            frmStudeProfile.mskPEPTExamDate.Text = dgstudentsearch.Item(57, dclick).Value
            frmStudeProfile.txtALSRating.Text = dgstudentsearch.Item(58, dclick).Value
            frmStudeProfile.txtAlsTestingCenter.Text = dgstudentsearch.Item(59, dclick).Value
            frmStudeProfile.txtNameExt.Text = dgstudentsearch.Item(60, dclick).Value
            frmStudeProfile.txtRFID.Text = dgstudentsearch.Item(61, dclick).Value
            frmStudeProfile.txtStudeId.Text = dgstudentsearch.Item(62, dclick).Value
            frmStudeProfile.cboClassification.Text = dgstudentsearch.Item(63, dclick).Value
            frmStudeProfile.txtFatherContactNo.Text = dgstudentsearch.Item(64, dclick).Value
            frmStudeProfile.txtMotherContactNo.Text = dgstudentsearch.Item(65, dclick).Value
            ...
            frmuseraccounts.txtUsername.ReadOnly = True

            frmStudeProfile.getAge()
            frmStudeProfile.getESCReq()
