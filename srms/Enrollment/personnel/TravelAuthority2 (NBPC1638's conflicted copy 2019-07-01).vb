...
Public Class TravelAuthority2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.TravelAuthority2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTravelAuthority2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TravelAuthority2 = New TravelAuthority2
        rpt.Site = Me.Site
        Return rpt
    End Function
