...
Public Class frmParent
    ...
    Private Sub Parent_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        schoolInfo()
        Me.Text = stSchool.Text + " | " + "POWERED BY SOFTTECH SOLUTIONS"
    ...
    Private Sub SemesterStudentToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SemesterStudentToolStripMenuItem.Click
        frmSemStudent.lblSem.Text = lblSem.Text
        frmSemStudent.lblSY.Text = lblSY.Text
        frmSemStudent.Show()
    End Sub
    ...
    Private Sub ChangePasswordToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ChangePasswordToolStripMenuItem.Click
        ...
        frmuseraccounts.tsSave.Enabled = False
        frmuseraccounts.tsDelete.Enabled = False
        frmuseraccounts.tsUpdate.Enabled = True
    ...
    Private Sub ORTrackingToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub ReportsToolStripMenuItem4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            str = "select * from calendar where SY='" & lblSY.Text & "'"
            conn.Open()
            Dim mysda As New MySqlDataAdapter(str, conn)
    ...
    Private Sub EntryFormToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub Backup1ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Backup1ToolStripMenuItem.Click
        Try
            ...
            'Process.Start("C:\Program Files\MySQL\MySQL Server 5.0\bin\mysqldump.exe", "--user=bpsedu_srms --password=compu7er  --host=localhost  --databases bpsedu_srms -r ""D:\db_backup\" + dateAll + "-bpsedu_srms.sql")
            Process.Start("C:\Program Files (x86)\MySQL\MySQL Server 5.4\bin\mysqldump.exe", "--user=root --password=compu7er  --host=localhost  --databases bpsedu_srms -r ""D:\db_backup\" + dateAll + "-bpsedu_srms.sql")
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Exclamation)
            conn.Close()
        End Try
    ...
    Private Sub ParentsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ParentsToolStripMenuItem.Click
        frmGuardianReportDashboard.Show()
    End Sub
    ...
    Private Sub BooksEntryToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        frmBooksInfo.Show()
    End Sub
    ...
    Private Sub ImportDTRToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ImportDTRToolStripMenuItem.Click
        frmImportDTR.Show()
    End Sub

    Private Sub EditDTRToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EditDTRToolStripMenuItem.Click
        frmEditDTR.Show()
    End Sub

    Private Sub DailyTimeRecordToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DailyTimeRecordToolStripMenuItem.Click
        frmStaffDTR.Show()
    End Sub

    Private Sub ByCashierToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ByCashierToolStripMenuItem.Click
        frmCollectionSummaryDashboard.Show()
    End Sub

    Private Sub GraduatesToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        frmGradForm.Show()
    End Sub
    ...
    Private Sub PreviousSchoolsFormToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PreviousSchoolsFormToolStripMenuItem.Click
        frmPrevSchool.Show()
    End Sub
    ...
    Private Sub CatalogingToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CatalogingToolStripMenuItem.Click
        frmBooksInfo.Show()
    End Sub
    ...
    Private Sub ListOfBooksByAuthorToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ListOfBooksByAuthorToolStripMenuItem.Click
        frmbyauthor.ShowDialog()
    End Sub

    Private Sub ListOfBooksToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ListOfBooksToolStripMenuItem.Click
        frmbycat.ShowDialog()
    End Sub
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        tsTime.Text = Format(TimeOfDay, "hh:mm:ss tt")
    End Sub
    ...
    Private Sub ReturnConsumablesToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ReturnConsumablesToolStripMenuItem.Click
        frmmodifyform.Show()
    End Sub

    Private Sub PARToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        frmMRDashboard.Show()
    End Sub

    Private Sub CountsToolStripMenuItem2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CountsToolStripMenuItem2.Click
        Try
            str = "SELECT i.ctrlNo, i.itemName, i.description, i.itemCondition, i.accountable, i.acquiredDate, ss.Division, ss.SchoolName, ss.SchoolAddress, ss.SchoolHead, ss.sHeadPosition, ss.PropertyCustodian, ss.letterHead FROM ls_items i join srms_settings ss on i.settingsID=ss.settingsID order by i.itemName, i.description"
            conn.Open()
            Dim mysDA As New MySqlDataAdapter(str, conn)
    ...
    Private Sub AttendanceToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AttendanceToolStripMenuItem.Click
        frmTimeIn.ShowDialog()
    End Sub

    Private Sub EntryFormToolStripMenuItem2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EntryFormToolStripMenuItem2.Click
        frmGatePass.Show()
    End Sub

    Private Sub ReportsToolStripMenuItem5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ReportsToolStripMenuItem5.Click
        frmGatePassDashboard.Show()
    End Sub

    Private Sub PassSlipToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub tsClassAttendance_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsClassAttendance.Click
        frmClassAttendanceForm.Show()
    End Sub

    Private Sub GradesViewingToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GradesViewingToolStripMenuItem.Click
        frmGradesViewing.Show()
    End Sub

    Private Sub ToolStripMenuItem4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ToolStripMenuItem4.Click
        frmStudeAttendance.Show()
    End Sub

    Private Sub DailyLogsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DailyLogsToolStripMenuItem.Click
        frmGatePassDashboard1.Show()
    End Sub
    ...
    Private Sub ByDepartmentToolStripMenuItem2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ByDepartmentToolStripMenuItem2.Click
        frmByDepartment.Show()
    End Sub

    Private Sub DailyLogsToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DailyLogsToolStripMenuItem1.Click
        frmGatePassDashboard1.Show()
    End Sub

    Private Sub StudentsLogsToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles StudentsLogsToolStripMenuItem.Click
        frmStudeAttendance.Show()
    End Sub
    ...
    Private Sub OnlineEnroleesToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OnlineEnroleesToolStripMenuItem.Click
    ...
    Private Sub ValidatedToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ValidatedToolStripMenuItem.Click
        Try
    ...
    Private Sub ConsolidatedAverageToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ConsolidatedAverageToolStripMenuItem.Click
        frmConsolidatedAverageSHS.Show()
    End Sub

    Private Sub EnrollmentSummaryV3ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EnrollmentSummaryV3ToolStripMenuItem.Click
        Try
    ...
    Private Sub EnrollmentSummaryV2ToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EnrollmentSummaryV2ToolStripMenuItem.Click
        Try
    ...
    Private Sub ClassListByGradeLevelToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ClassListByGradeLevelToolStripMenuItem.Click
        frmClassListByGradeLevel.ShowDialog()
    End Sub
End Class