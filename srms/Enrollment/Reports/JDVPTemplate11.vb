...
Public Class JDVPTemplate11
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.JDVPTemplate11.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJDVPTemplate11
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JDVPTemplate11 = New JDVPTemplate11
        rpt.Site = Me.Site
        Return rpt
    End Function
