...
Public Class ReportCardJHS2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ReportCardJHS2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportCardJHS2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportCardJHS2 = New ReportCardJHS2
        rpt.Site = Me.Site
        Return rpt
    End Function
