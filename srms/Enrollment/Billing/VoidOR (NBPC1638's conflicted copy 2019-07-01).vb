...
Public Class frmVoidOR
    ...
    Private Sub tsSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsSave.Click
        Try
            ...
            'update billing
            str = "update studeaccount set StudentNumber='" & lblStudentNumber.Text & "',AcctTotal='" & txtTotalAccts.Text & "',TotalPayments='" & txtTotalPayments.Text & "',CurrentBalance='" & txtBalance.Text & "',DateUpdated='" & Convert.ToDateTime(frmParent.dtpDate.Text).ToString("yyyy-MM-dd") & "' where StudentNumber='" & lblStudentNumber.Text & "' and SY='" & frmParent.lblSY.Text & "' and Sem='" & frmParent.lblSem.Text & "'"
            conn.Open()
