...
Partial Public Class Reports
    ...
    Partial Public Class ClearanceDataTable
        ...
        Public Overloads Function AddClearanceRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {StudentNumber, Fullname, Course, YearLevel, SubjectCode, Description, LecUnit, LabUnit, Section, SchedTime, LabTime, Room, Semester, SY, Semester1, SY1, Instructor}
...
Namespace ReportsTableAdapters
    ...
    Partial Public Class paymentsaccountsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`paymentsaccounts` WHERE ((`ID` = @Original_ID) AND (`St"& _ 
                "udentNumber` = @Original_StudentNumber) AND (`FirstName` = @Original_FirstName) "& _ 
                "AND (`MiddleName` = @Original_MiddleName) AND (`LastName` = @Original_LastName) "& _ 
                "AND (`PDate` = @Original_PDate) AND (`ORNumber` = @Original_ORNumber) AND (`Amou"& _ 
                "nt` = @Original_Amount) AND (`PaymentType` = @Original_PaymentType) AND (`CheckN"& _ 
                "umber` = @Original_CheckNumber) AND (`Sem` = @Original_Sem) AND (`SY` = @Origina"& _ 
                "l_SY) AND (`Address` = @Original_Address) AND (`Term` = @Original_Term))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `deped_srms`.`paymentsaccounts` (`StudentNumber`, `FirstName`, `Middl"& _ 
                "eName`, `LastName`, `PDate`, `ORNumber`, `Amount`, `PaymentType`, `CheckNumber`,"& _ 
                " `Sem`, `SY`, `Address`, `Term`) VALUES (@StudentNumber, @FirstName, @MiddleName"& _ 
                ", @LastName, @PDate, @ORNumber, @Amount, @PaymentType, @CheckNumber, @Sem, @SY, "& _ 
                "@Address, @Term)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`paymentsaccounts` SET `StudentNumber` = @StudentNumber, `Fir"& _ 
                "stName` = @FirstName, `MiddleName` = @MiddleName, `LastName` = @LastName, `PDate"& _ 
                "` = @PDate, `ORNumber` = @ORNumber, `Amount` = @Amount, `PaymentType` = @Payment"& _ 
                "Type, `CheckNumber` = @CheckNumber, `Sem` = @Sem, `SY` = @SY, `Address` = @Addre"& _ 
                "ss, `Term` = @Term WHERE ((`ID` = @Original_ID) AND (`StudentNumber` = @Original"& _ 
                "_StudentNumber) AND (`FirstName` = @Original_FirstName) AND (`MiddleName` = @Ori"& _ 
                "ginal_MiddleName) AND (`LastName` = @Original_LastName) AND (`PDate` = @Original"& _ 
                "_PDate) AND (`ORNumber` = @Original_ORNumber) AND (`Amount` = @Original_Amount) "& _ 
                "AND (`PaymentType` = @Original_PaymentType) AND (`CheckNumber` = @Original_Check"& _ 
                "Number) AND (`Sem` = @Original_Sem) AND (`SY` = @Original_SY) AND (`Address` = @"& _ 
    ...
    Partial Public Class CollectionsSummaryTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`paymentsaccounts` WHERE ((`PDate` = @Original_PDate) AN"& _ 
                "D (`ORNumber` = @Original_ORNumber) AND (`Amount` = @Original_Amount) AND (`Stud"& _ 
                "entNumber` = @Original_StudentNumber) AND (`Cashier` = @Original_Cashier) AND (`"& _ 
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`paymentsaccounts` SET `PDate` = @PDate, `ORNumber` = @ORNumb"& _ 
                "er, `Amount` = @Amount, `StudentNumber` = @StudentNumber, `Cashier` = @Cashier, "& _ 
                "`ORStatus` = @ORStatus WHERE ((`PDate` = @Original_PDate) AND (`ORNumber` = @Ori"& _ 
                "ginal_ORNumber) AND (`Amount` = @Original_Amount) AND (`StudentNumber` = @Origin"& _ 
                "al_StudentNumber) AND (`Cashier` = @Original_Cashier) AND (`ORStatus` = @Origina"& _ 
                "l_ORStatus) AND (`ID` = @Original_ID))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@PDate"
            param.DbType = Global.System.Data.DbType.[Date]
    ...
    Partial Public Class incomestatementTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`incomestatement` WHERE ((`isID` = @Original_isID) AND ("& _ 
                "`DateFrom` = @Original_DateFrom) AND (`DateTo` = @Original_DateTo) AND (`StudeAc"& _ 
                "cts` = @Original_StudeAccts) AND (`Expenses` = @Original_Expenses) AND (`NetInco"& _ 
                "me` = @Original_NetIncome))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.InsertCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `deped_srms`.`incomestatement` (`DateFrom`, `DateTo`, `StudeAccts`, `"& _ 
                "Expenses`, `NetIncome`) VALUES (@DateFrom, @DateTo, @StudeAccts, @Expenses, @Net"& _ 
                "Income)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`incomestatement` SET `DateFrom` = @DateFrom, `DateTo` = @Dat"& _ 
                "eTo, `StudeAccts` = @StudeAccts, `Expenses` = @Expenses, `NetIncome` = @NetIncom"& _ 
                "e WHERE ((`isID` = @Original_isID) AND (`DateFrom` = @Original_DateFrom) AND (`D"& _ 
                "ateTo` = @Original_DateTo) AND (`StudeAccts` = @Original_StudeAccts) AND (`Expen"& _ 
                "ses` = @Original_Expenses) AND (`NetIncome` = @Original_NetIncome))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@DateFrom"
            param.DbType = Global.System.Data.DbType.[Date]
    ...
    Partial Public Class promissoryNotesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`promissory` WHERE ((`promissoryID` = @Original_promisso"& _ 
                "ryID) AND (`DateApplied` = @Original_DateApplied) AND (`StudentNumber` = @Origin"& _ 
                "al_StudentNumber) AND (`Guardian` = @Original_Guardian) AND (`Amount` = @Origina"& _ 
                "l_Amount) AND (`PromisedDate` = @Original_PromisedDate) AND (`Status` = @Origina"& _ 
                "l_Status) AND (`Sem` = @Original_Sem) AND (`SY` = @Original_SY))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`promissory` SET `DateApplied` = @DateApplied, `StudentNumber"& _ 
                "` = @StudentNumber, `Guardian` = @Guardian, `Amount` = @Amount, `PromisedDate` ="& _ 
                " @PromisedDate, `Status` = @Status, `Sem` = @Sem, `SY` = @SY WHERE ((`promissory"& _ 
                "ID` = @Original_promissoryID) AND (`DateApplied` = @Original_DateApplied) AND (`"& _ 
                ...
                "AND (`Status` = @Original_Status) AND (`Sem` = @Original_Sem) AND (`SY` = @Origi"& _ 
                "nal_SY))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
    ...
    Partial Public Class SchedulesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`semsubjects` WHERE ((`subjectid` = @Original_subjectid)"& _ 
                ...
                "LecUnit = 1 AND `LecUnit` IS NULL) OR (`LecUnit` = @Original_LecUnit)) AND ((@Is"& _ 
                "Null_LabUnit = 1 AND `LabUnit` IS NULL) OR (`LabUnit` = @Original_LabUnit)) AND "& _ 
                "((@IsNull_Section = 1 AND `Section` IS NULL) OR (`Section` = @Original_Section))"& _ 
                " AND ((@IsNull_LabTime = 1 AND `LabTime` IS NULL) OR (`LabTime` = @Original_LabT"& _ 
                "ime)) AND ((@IsNull_SchedTime = 1 AND `SchedTime` IS NULL) OR (`SchedTime` = @Or"& _ 
                "iginal_SchedTime)) AND ((@IsNull_Room = 1 AND `Room` IS NULL) OR (`Room` = @Orig"& _ 
                "inal_Room)) AND ((@IsNull_Slot = 1 AND `Slot` IS NULL) OR (`Slot` = @Original_Sl"& _ 
                "ot)) AND (`IDNumber` = @Original_IDNumber) AND ((@IsNull_SY = 1 AND `SY` IS NULL"& _ 
                ") OR (`SY` = @Original_SY)) AND ((@IsNull_Semester = 1 AND `Semester` IS NULL) O"& _ 
                "R (`Semester` = @Original_Semester)) AND ((@IsNull_Instructor = 1 AND `Instructo"& _ 
                "r` IS NULL) OR (`Instructor` = @Original_Instructor)) AND ((@IsNull_Time1 = 1 AN"& _ 
                "D `Time1` IS NULL) OR (`Time1` = @Original_Time1)) AND ((@IsNull_AM1 = 1 AND `AM"& _ 
                "1` IS NULL) OR (`AM1` = @Original_AM1)) AND ((@IsNull_Time2 = 1 AND `Time2` IS N"& _ 
                "ULL) OR (`Time2` = @Original_Time2)) AND ((@IsNull_AM2 = 1 AND `AM2` IS NULL) OR"& _ 
                " (`AM2` = @Original_AM2)) AND ((@IsNull_Time3 = 1 AND `Time3` IS NULL) OR (`Time"& _ 
                "3` = @Original_Time3)) AND ((@IsNull_AM3 = 1 AND `AM3` IS NULL) OR (`AM3` = @Ori"& _ 
                "ginal_AM3)) AND (`Time4` = @Original_Time4) AND (`AM4` = @Original_AM4) AND (`Da"& _ 
                "ys1` = @Original_Days1) AND (`Days2` = @Original_Days2) AND (`Course` = @Origina"& _ 
                "l_Course) AND (`YearLevel` = @Original_YearLevel) AND (`SubjectStatus` = @Origin"& _ 
                "al_SubjectStatus))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.InsertCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `deped_srms`.`semsubjects` (`SubjectCode`, `Description`, `LecUnit`, "& _ 
                "`LabUnit`, `Section`, `LabTime`, `SchedTime`, `Room`, `Slot`, `IDNumber`, `SY`, "& _ 
                "`Semester`, `Instructor`, `Time1`, `AM1`, `Time2`, `AM2`, `Time3`, `AM3`, `Time4"& _ 
                "`, `AM4`, `Days1`, `Days2`, `Course`, `YearLevel`, `SubjectStatus`) VALUES (@Sub"& _ 
                "jectCode, @Description, @LecUnit, @LabUnit, @Section, @LabTime, @SchedTime, @Roo"& _ 
                "m, @Slot, @IDNumber, @SY, @Semester, @Instructor, @Time1, @AM1, @Time2, @AM2, @T"& _ 
                "ime3, @AM3, @Time4, @AM4, @Days1, @Days2, @Course, @YearLevel, @SubjectStatus)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`semsubjects` SET `SubjectCode` = @SubjectCode, `Description`"& _ 
                " = @Description, `LecUnit` = @LecUnit, `LabUnit` = @LabUnit, `Section` = @Sectio"& _ 
                "n, `LabTime` = @LabTime, `SchedTime` = @SchedTime, `Room` = @Room, `Slot` = @Slo"& _ 
                "t, `IDNumber` = @IDNumber, `SY` = @SY, `Semester` = @Semester, `Instructor` = @I"& _ 
                "nstructor, `Time1` = @Time1, `AM1` = @AM1, `Time2` = @Time2, `AM2` = @AM2, `Time"& _ 
                "3` = @Time3, `AM3` = @AM3, `Time4` = @Time4, `AM4` = @AM4, `Days1` = @Days1, `Da"& _ 
                "ys2` = @Days2, `Course` = @Course, `YearLevel` = @YearLevel, `SubjectStatus` = @"& _ 
                "SubjectStatus WHERE ((`subjectid` = @Original_subjectid) AND (`SubjectCode` = @O"& _ 
                "riginal_SubjectCode) AND ((@IsNull_Description = 1 AND `Description` IS NULL) OR"& _ 
                " (`Description` = @Original_Description)) AND ((@IsNull_LecUnit = 1 AND `LecUnit"& _ 
                "` IS NULL) OR (`LecUnit` = @Original_LecUnit)) AND ((@IsNull_LabUnit = 1 AND `La"& _ 
                "bUnit` IS NULL) OR (`LabUnit` = @Original_LabUnit)) AND ((@IsNull_Section = 1 AN"& _ 
                "D `Section` IS NULL) OR (`Section` = @Original_Section)) AND ((@IsNull_LabTime ="& _ 
                " 1 AND `LabTime` IS NULL) OR (`LabTime` = @Original_LabTime)) AND ((@IsNull_Sche"& _ 
                "dTime = 1 AND `SchedTime` IS NULL) OR (`SchedTime` = @Original_SchedTime)) AND ("& _ 
                "(@IsNull_Room = 1 AND `Room` IS NULL) OR (`Room` = @Original_Room)) AND ((@IsNul"& _ 
                "l_Slot = 1 AND `Slot` IS NULL) OR (`Slot` = @Original_Slot)) AND (`IDNumber` = @"& _ 
                "Original_IDNumber) AND ((@IsNull_SY = 1 AND `SY` IS NULL) OR (`SY` = @Original_S"& _ 
                "Y)) AND ((@IsNull_Semester = 1 AND `Semester` IS NULL) OR (`Semester` = @Origina"& _ 
                "l_Semester)) AND ((@IsNull_Instructor = 1 AND `Instructor` IS NULL) OR (`Instruc"& _ 
                "tor` = @Original_Instructor)) AND ((@IsNull_Time1 = 1 AND `Time1` IS NULL) OR (`"& _ 
                "Time1` = @Original_Time1)) AND ((@IsNull_AM1 = 1 AND `AM1` IS NULL) OR (`AM1` = "& _ 
                "@Original_AM1)) AND ((@IsNull_Time2 = 1 AND `Time2` IS NULL) OR (`Time2` = @Orig"& _ 
                "inal_Time2)) AND ((@IsNull_AM2 = 1 AND `AM2` IS NULL) OR (`AM2` = @Original_AM2)"& _ 
                ") AND ((@IsNull_Time3 = 1 AND `Time3` IS NULL) OR (`Time3` = @Original_Time3)) A"& _ 
                "ND ((@IsNull_AM3 = 1 AND `AM3` IS NULL) OR (`AM3` = @Original_AM3)) AND (`Time4`"& _ 
                " = @Original_Time4) AND (`AM4` = @Original_AM4) AND (`Days1` = @Original_Days1) "& _ 
                "AND (`Days2` = @Original_Days2) AND (`Course` = @Original_Course) AND (`YearLeve"& _ 
                "l` = @Original_YearLevel) AND (`SubjectStatus` = @Original_SubjectStatus))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@SubjectCode"
            param.DbType = Global.System.Data.DbType.[String]
    ...
    Partial Public Class ClearanceTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "select r.StudentNumber, concat(p.FirstName,' ',p.MiddleName,' ',p.LastName) as Fu"& _ 
                ...
                "oolAddress from registration r join semsubjects ss on ss.SubjectCode = r.Subject"& _ 
                "Code join semesterstude s on s.StudentNumber = r.StudentNumber join studeprofile"& _ 
                " p on p.StudentNumber = r.StudentNumber join staff sf on sf.IDNumber=ss.IDNumber"& _ 
                " join srms_settings sr on p.settingsID=sr.settingsID"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
