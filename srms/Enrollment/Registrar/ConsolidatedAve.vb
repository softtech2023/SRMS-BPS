...
Public Class ConsolidatedAve
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.ConsolidatedAve.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsolidatedAve
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsolidatedAve = New ConsolidatedAve
        rpt.Site = Me.Site
        Return rpt
    End Function
