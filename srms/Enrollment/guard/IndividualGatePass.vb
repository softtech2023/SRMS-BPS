...
Public Class IndividualGatePass
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.IndividualGatePass.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIndividualGatePass
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IndividualGatePass = New IndividualGatePass
        rpt.Site = Me.Site
        Return rpt
    End Function
