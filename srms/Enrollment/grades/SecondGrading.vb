...
Public Class frmSecondGrading
    ...
    Public Sub getStatus()
        Try
            ...
            cboStatus.DisplayMember = "secondStat"
    ...
    Private Sub frmMGrade(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        formLoad()
    End Sub
    Public Sub formLoad()
        getInstructor()
    ...
    Private Sub frmMGrade_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        getInstructor()
        tsSave.Enabled = False
    End Sub
    Public Sub getAverage()
        Try
            ...
            icellResult = (Val(iCell1) + Val(icell2)) / 2
    ...
    Private Sub tsDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsDelete.Click
        Try
            If (MsgBox("You are about to delete 2nd grading grades.  Do you want to continue?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes) Then
                str = "update grades set MGrade=0,secondStat='Open' where SubjectCode='" & txtSubjectcode.Text & "' and Description='" & txtDescription.Text & "' and Instructor='" & txtInstructor.Text & "' and Section='" & txtSection.Text & "' and Sem='" & frmParent.lblSem.Text & "' and SY='" & frmParent.lblSY.Text & "'"
                conn.Open()
                Dim mysc As New MySqlCommand(str, conn)
                mysc.ExecuteNonQuery()
                conn.Close()
                MsgBox("2nd Grading grades successfully deleted!", MsgBoxStyle.Information)
                Clear()
                formLoad()
            End If
        Catch ex As Exception
