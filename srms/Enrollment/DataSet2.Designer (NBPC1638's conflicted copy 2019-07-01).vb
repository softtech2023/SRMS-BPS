...
Partial Public Class DataSet2
    ...
    Partial Public Class acctTrackingDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddacctTrackingRow(ByVal StudentNumber As String, ByVal StudentName As String, ByVal Course As String, ByVal AcctTotal As Double, ByVal TotalPayments As Double, ByVal CurrentBalance As Double, ByVal SY As String) As acctTrackingRow
            Dim rowacctTrackingRow As acctTrackingRow = CType(Me.NewRow,acctTrackingRow)
            Dim columnValuesArray() As Object = New Object() {StudentNumber, StudentName, Course, AcctTotal, TotalPayments, CurrentBalance, SY}
    ...
    Partial Public Class enrolmentCountSummaryDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddenrolmentCountSummaryRow(ByVal YearLevel As String, ByVal sex As String, ByVal Semester As String, ByVal SY As String, ByVal SchoolName As String, ByVal SchoolAddress As String, ByVal sexCount As Long, ByVal Course As String, ByVal Track As String, ByVal Qualification As String, ByVal letterHead() As Byte) As enrolmentCountSummaryRow
            Dim rowenrolmentCountSummaryRow As enrolmentCountSummaryRow = CType(Me.NewRow,enrolmentCountSummaryRow)
            Dim columnValuesArray() As Object = New Object() {YearLevel, sex, Semester, SY, SchoolName, SchoolAddress, sexCount, Course, Track, Qualification, letterHead}
    ...
    Partial Public Class RatingReportDataTable
        ...
        Public Overloads Function AddRatingReportRow( _
                    ...
                    ByVal Division As String,  _
                    ByVal _Region As String,  _
                    ByVal letterHead() As Byte) As RatingReportRow
            Dim rowRatingReportRow As RatingReportRow = CType(Me.NewRow,RatingReportRow)
            Dim columnValuesArray() As Object = New Object() {StudentNumber, StudeName, Sex, BirthDate, Age, BirthPlace, Guardian, Course, YearLevel, Adviser, Section, Track, Qualification, Description, PGrade, MGrade, PFinalGrade, FGrade, Average, SY, SchoolName, SchoolAddress, SchoolHead, sHeadPosition, Division, _Region, letterHead}
    ...
    Partial Public Class enrolmentCountSummaryRow
        ...
        Public Property sex() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'sex' in table 'enrolmentCountSummary' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Function IssexNull() As Boolean
            Return Me.IsNull(Me.tableenrolmentCountSummary.sexColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetsexNull()
            Me(Me.tableenrolmentCountSummary.sexColumn) = Global.System.Convert.DBNull
        End Sub
    ...
    Partial Public Class RatingReportRow
        ...
        Public Property YearLevel() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'YearLevel' in table 'RatingReport' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Property Qualification() As String
            Get
                Return CType(Me(Me.tableRatingReport.QualificationColumn),String)
            End Get
            Set
                Me(Me.tableRatingReport.QualificationColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsYearLevelNull() As Boolean
            Return Me.IsNull(Me.tableRatingReport.YearLevelColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetYearLevelNull()
            Me(Me.tableRatingReport.YearLevelColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace DataSet2TableAdapters
    ...
    Partial Public Class installmentfeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`installmentfee` WHERE ((`installmentID` = @Original_ins"& _ 
                "tallmentID) AND (`Course` = @Original_Course) AND (`YearLevel` = @Original_YearL"& _ 
                "evel) AND (`Plan` = @Original_Plan) AND (`InstallmentFee` = @Original_Installmen"& _ 
                "tFee))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `deped_srms`.`installmentfee` (`Course`, `YearLevel`, `Plan`, `Instal"& _ 
                "lmentFee`) VALUES (@Course, @YearLevel, @Plan, @InstallmentFee)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`installmentfee` SET `Course` = @Course, `YearLevel` = @YearL"& _ 
                "evel, `Plan` = @Plan, `InstallmentFee` = @InstallmentFee WHERE ((`installmentID`"& _ 
                " = @Original_installmentID) AND (`Course` = @Original_Course) AND (`YearLevel` ="& _ 
                " @Original_YearLevel) AND (`Plan` = @Original_Plan) AND (`InstallmentFee` = @Ori"& _ 
                "ginal_InstallmentFee))"
    ...
    Partial Public Class cashierAcctTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`users` WHERE ((`username` = @Original_username) AND (`p"& _ 
                "assword` = @Original_password) AND (`position` = @Original_position) AND (`email"& _ 
                "` = @Original_email))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.InsertCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `deped_srms`.`users` (`username`, `password`, `position`, `email`) VA"& _ 
                "LUES (@username, @password, @position, @email)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`users` SET `username` = @username, `password` = @password, `"& _ 
                "position` = @position, `email` = @email WHERE ((`username` = @Original_username)"& _ 
                " AND (`password` = @Original_password) AND (`position` = @Original_position) AND"& _ 
    ...
    Partial Public Class get_majorTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`course_table` WHERE ((`Major` = @Original_Major) AND (`"& _ 
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`course_table` SET `Major` = @Major WHERE ((`Major` = @Origin"& _ 
                "al_Major) AND (`courseid` = @Original_courseid))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
    ...
    Partial Public Class acctTrackingTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "Select p.StudentNumber, concat(p.FirstName,' ',p.MiddleName,' ',p.LastName) as St"& _ 
                "udentName, p.Course, s.SY, s.AcctTotal, s.TotalPayments, s.CurrentBalance from s"& _ 
                "tudeprofile p join studeaccount s on p.StudentNumber=s.StudentNumber group by s."& _ 
                "StudentNumber"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class ethnicityTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`studeprofile` WHERE ((`Ethnicity` = @Original_Ethnicity"& _ 
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`studeprofile` SET `Ethnicity` = @Ethnicity, `StudentNumber` "& _ 
    ...
    Partial Public Class provinceTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`studeprofile` WHERE ((`Province` = @Original_Province) "& _ 
                "AND (`StudentNumber` = @Original_StudentNumber))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`studeprofile` SET `Province` = @Province, `StudentNumber` = "& _ 
    ...
    Partial Public Class CityTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`studeprofile` WHERE ((`City` = @Original_City) AND (`St"& _ 
                "udentNumber` = @Original_StudentNumber))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`studeprofile` SET `City` = @City, `StudentNumber` = @Student"& _ 
                "Number WHERE ((`City` = @Original_City) AND (`StudentNumber` = @Original_Student"& _ 
                "Number))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
    ...
    Partial Public Class BrgyTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`studeprofile` WHERE ((`Brgy` = @Original_Brgy) AND (`St"& _ 
                "udentNumber` = @Original_StudentNumber))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`studeprofile` SET `Brgy` = @Brgy, `StudentNumber` = @Student"& _ 
                "Number WHERE ((`Brgy` = @Original_Brgy) AND (`StudentNumber` = @Original_Student"& _ 
                "Number))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
    ...
    Partial Public Class ReligionTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`studeprofile` WHERE ((`Religion` = @Original_Religion) "& _ 
                "AND (`StudentNumber` = @Original_StudentNumber))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`studeprofile` SET `Religion` = @Religion, `StudentNumber` = "& _ 
    ...
    Partial Public Class enrolmentCountSummaryTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "select ss.YearLevel, mid(p.sex,1,1) as sex, count(p.sex) as sexCount, ss.Course, "& _ 
                "ss.Track, ss.Qualification, ss.Semester, ss.SY, st.SchoolName, st.SchoolAddress,"& _ 
                " st.letterHead from semesterstude ss join srms_settings st on ss.settingsID=st.s"& _ 
                "ettingsID join studeprofile p on p.StudentNumber=ss.StudentNumber group by p.Sex"& _ 
                ""
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class RatingReportTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "select p.StudentNumber, concat(p.LastName,', ',p.FirstName,' ',p.MiddleName) as S"& _ 
                ...
                "rLevel, ss.Adviser, ss.Section, ss.Track, ss.Qualification, g.Description, g.PGr"& _ 
                "ade, g.MGrade, g.PFinalGrade, g.FGrade, g.Average, g.SY, sr.SchoolName, sr.Schoo"& _ 
                "lAddress, sr.SchoolHead, sr.sHeadPosition,sr.Division,sr.Region, sr.letterHead f"& _ 
                "rom studeprofile p join semesterstude ss on p.StudentNumber=ss.StudentNumber joi"& _ 
                "n grades g on ss.StudentNumber=g.StudentNumber join srms_settings sr on ss.setti"& _ 
                "ngsID=sr.settingsID"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
