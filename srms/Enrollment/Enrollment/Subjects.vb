...
Public Class frmSubjects
    ...
    Private Sub DataGridView1_DoubleClick1(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgsubjects.DoubleClick
        Try
            ...
            cboCategory.Text = dgsubjects.Item(13, dclick).Value
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Information)
            conn.Close()
        End Try
    ...
    Private Sub tsSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsSave.Click
        Try
            ...
            str = "insert into subjects values('0','" & txtSubjectCode.Text & "','" & txtdescription.Text & "','" & txtLecUnits.Text & "','0','" & txtPreq.Text & "','" & txtCurriculum.Text & "','" & cboYearLevel.Text & "','" & cboSemester.Text & "','" & cboCourse.Text & "','" & cboSemEffective.Text & "','" & txtSYEffective.Text & "','" & txtEffective.Text & "','" & cboCategory.Text & "')"
            conn.Open()
    ...
    Private Sub tsUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsUpdate.Click
        Try
            str = "update subjects set SubjectCode='" & txtSubjectCode.Text & "',description='" & txtdescription.Text & "',lecunit='" & txtLecUnits.Text & "',labunit='" & txtLabUnits.Text & "',prereq='" & txtPreq.Text & "',curriculum='" & txtCurriculum.Text & "',YearLevel='" & cboYearLevel.Text & "',Semester='" & cboSemester.Text & "',Course='" & cboCourse.Text & "',SemEffective='" & cboSemEffective.Text & "',SYEffective='" & txtSYEffective.Text & "',Effectivity='" & txtEffective.Text & "',subCategory='" & cboCategory.Text & "' where subjectid='" & lblID.Text & "'"
            conn.Open()
            Dim mysC As New MySqlCommand(str, conn)
            mysC.ExecuteNonQuery()
