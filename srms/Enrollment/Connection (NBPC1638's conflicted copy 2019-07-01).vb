...
Module Connection
    Public conn As New MySqlConnection("Database=deped_srms;" & _
                                           "Server =localhost;" & _
                                           "User ID = deped; Password =compu7er;")
    Public conn1 As New MySqlConnection("Database=deped_srms;" & _
                                   "Server =localhost;" & _
                                   "User ID = deped; Password =compu7er;")
    ...
    End Sub
    Public Sub ClearTextBox(ByVal deped_srms As Control)
        For Each ctrl As Control In deped_srms.Controls
            ClearTextBox(ctrl)
