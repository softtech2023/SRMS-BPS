...
Public Class DiplomaPrinting
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.DiplomaPrinting.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDiplomaPrinting
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DiplomaPrinting = New DiplomaPrinting
        rpt.Site = Me.Site
        Return rpt
    End Function
