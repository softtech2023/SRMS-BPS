...
Partial Public Class Reports
    ...
    Partial Public Class EnrollmentHistoryDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddEnrollmentHistoryRow(ByVal StudentNumber As String, ByVal StudentName As String, ByVal Course As String, ByVal YearLevel As String, ByVal SY As String, ByVal Semester As String) As EnrollmentHistoryRow
            Dim rowEnrollmentHistoryRow As EnrollmentHistoryRow = CType(Me.NewRow,EnrollmentHistoryRow)
            Dim columnValuesArray() As Object = New Object() {StudentNumber, StudentName, Course, YearLevel, SY, Semester}
    ...
    Partial Public Class ScholarsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddScholarsRow(ByVal StudentNumber As String, ByVal StudentName As String, ByVal Course As String, ByVal YearLevel As String, ByVal Semester As String, ByVal SY As String, ByVal Scholarship As String, ByVal PayingStatus As String, ByVal GrantAmount As Double) As ScholarsRow
            Dim rowScholarsRow As ScholarsRow = CType(Me.NewRow,ScholarsRow)
            Dim columnValuesArray() As Object = New Object() {StudentNumber, StudentName, Course, YearLevel, Semester, SY, Scholarship, PayingStatus, GrantAmount}
        ...
        Private Sub InitClass()
            ...
            Me.columnStudentNumber.Unique = true
            Me.columnStudentNumber.MaxLength = 45
            Me.columnStudentName.MaxLength = 92
            Me.columnCourse.MaxLength = 250
            Me.columnYearLevel.MaxLength = 45
            Me.columnSemester.MaxLength = 45
            Me.columnSY.MaxLength = 45
    ...
    Partial Public Class ScholarsRow
        ...
        Public Property StudentName() As String
            Get
                Try 
                    Return CType(Me(Me.tableScholars.StudentNameColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'StudentName' in table 'Scholars' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableScholars.StudentNameColumn) = value
            End Set
        End Property
        ...
        Public Property PayingStatus() As String
            Get
                Return CType(Me(Me.tableScholars.PayingStatusColumn),String)
            End Get
            Set
                Me(Me.tableScholars.PayingStatusColumn) = value
            End Set
        End Property
        ...
        Public Property GrantAmount() As Double
            Get
                Return CType(Me(Me.tableScholars.GrantAmountColumn),Double)
            End Get
            Set
                Me(Me.tableScholars.GrantAmountColumn) = value
            End Set
        End Property
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsStudentNameNull() As Boolean
            Return Me.IsNull(Me.tableScholars.StudentNameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetStudentNameNull()
            Me(Me.tableScholars.StudentNameColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace ReportsTableAdapters
    ...
    Partial Public Class EnrollmentHistoryTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "select p.StudentNumber, concat(p.FirstName,' ',p.MiddleName,' ',p.LastName) as St"& _ 
                "udentName, s.Course, s.YearLevel, s.SY, s.Semester from studeprofile p join seme"& _ 
                "sterstude s on p.StudentNumber=s.StudentNumber"
    ...
    Partial Public Class paymentsaccountsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `savhs`.`paymentsaccounts` WHERE ((`ID` = @Original_ID) AND (`Student"& _ 
                "Number` = @Original_StudentNumber) AND (`FirstName` = @Original_FirstName) AND ("& _ 
                "`MiddleName` = @Original_MiddleName) AND (`LastName` = @Original_LastName) AND ("& _ 
                "`PDate` = @Original_PDate) AND (`ORNumber` = @Original_ORNumber) AND (`Amount` ="& _ 
                " @Original_Amount) AND (`PaymentType` = @Original_PaymentType) AND (`CheckNumber"& _ 
                "` = @Original_CheckNumber) AND (`Sem` = @Original_Sem) AND (`SY` = @Original_SY)"& _ 
                " AND (`Address` = @Original_Address) AND (`Term` = @Original_Term))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `savhs`.`paymentsaccounts` (`StudentNumber`, `FirstName`, `MiddleName"& _ 
                "`, `LastName`, `PDate`, `ORNumber`, `Amount`, `PaymentType`, `CheckNumber`, `Sem"& _ 
                "`, `SY`, `Address`, `Term`) VALUES (@StudentNumber, @FirstName, @MiddleName, @La"& _ 
                "stName, @PDate, @ORNumber, @Amount, @PaymentType, @CheckNumber, @Sem, @SY, @Addr"& _ 
                "ess, @Term)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `savhs`.`paymentsaccounts` SET `StudentNumber` = @StudentNumber, `FirstNam"& _ 
                "e` = @FirstName, `MiddleName` = @MiddleName, `LastName` = @LastName, `PDate` = @"& _ 
                "PDate, `ORNumber` = @ORNumber, `Amount` = @Amount, `PaymentType` = @PaymentType,"& _ 
                " `CheckNumber` = @CheckNumber, `Sem` = @Sem, `SY` = @SY, `Address` = @Address, `"& _ 
                "Term` = @Term WHERE ((`ID` = @Original_ID) AND (`StudentNumber` = @Original_Stud"& _ 
                "entNumber) AND (`FirstName` = @Original_FirstName) AND (`MiddleName` = @Original"& _ 
                "_MiddleName) AND (`LastName` = @Original_LastName) AND (`PDate` = @Original_PDat"& _ 
                "e) AND (`ORNumber` = @Original_ORNumber) AND (`Amount` = @Original_Amount) AND ("& _ 
                "`PaymentType` = @Original_PaymentType) AND (`CheckNumber` = @Original_CheckNumbe"& _ 
                "r) AND (`Sem` = @Original_Sem) AND (`SY` = @Original_SY) AND (`Address` = @Origi"& _ 
                "nal_Address) AND (`Term` = @Original_Term))"
    ...
    Partial Public Class CollectionsSummaryTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `savhs`.`paymentsaccounts` WHERE ((`PDate` = @Original_PDate) AND (`O"& _ 
                "RNumber` = @Original_ORNumber) AND (`Amount` = @Original_Amount) AND (`StudentNu"& _ 
                "mber` = @Original_StudentNumber) AND (`Cashier` = @Original_Cashier) AND (`ORSta"& _ 
                "tus` = @Original_ORStatus) AND (`ID` = @Original_ID))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@Original_PDate"
            param.DbType = Global.System.Data.DbType.[Date]
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `savhs`.`paymentsaccounts` SET `PDate` = @PDate, `ORNumber` = @ORNumber, `"& _ 
                "Amount` = @Amount, `StudentNumber` = @StudentNumber, `Cashier` = @Cashier, `ORSt"& _ 
                "atus` = @ORStatus WHERE ((`PDate` = @Original_PDate) AND (`ORNumber` = @Original"& _ 
                "_ORNumber) AND (`Amount` = @Original_Amount) AND (`StudentNumber` = @Original_St"& _ 
                "udentNumber) AND (`Cashier` = @Original_Cashier) AND (`ORStatus` = @Original_ORS"& _ 
                "tatus) AND (`ID` = @Original_ID))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@PDate"
            param.DbType = Global.System.Data.DbType.[Date]
    ...
    Partial Public Class ScholarsTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "select p.StudentNumber, concat(p.LastName,', ',p.FirstName,' ',p.MiddleName) as S"& _ 
                "tudentName, ss.YearLevel, ss.Course, ss.Semester, ss.SY, ss.Scholarship, ss.Payi"& _ 
                "ngStatus, ss.GrantAmount from studeprofile p join semesterstude ss on p.StudentN"& _ 
                "umber=ss.StudentNumber"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class studeprofileTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `savhs`.`studeprofile` WHERE ((`StudentNumber` = @Original_StudentNum"& _ 
                "ber) AND ((@IsNull_FirstName = 1 AND `FirstName` IS NULL) OR (`FirstName` = @Ori"& _ 
                "ginal_FirstName)) AND ((@IsNull_MiddleName = 1 AND `MiddleName` IS NULL) OR (`Mi"& _ 
                "ddleName` = @Original_MiddleName)) AND ((@IsNull_LastName = 1 AND `LastName` IS "& _ 
                "NULL) OR (`LastName` = @Original_LastName)) AND (`Sex` = @Original_Sex) AND (`Ci"& _ 
                "vilStatus` = @Original_CivilStatus) AND (`BirthPlace` = @Original_BirthPlace) AN"& _ 
                "D (`Citizenship` = @Original_Citizenship) AND (`Religion` = @Original_Religion) "& _ 
                "AND (`BloodType` = @Original_BloodType) AND (`TelNumber` = @Original_TelNumber) "& _ 
                "AND (`MobileNumber` = @Original_MobileNumber) AND (`HighSchool` = @Original_High"& _ 
                "School) AND (`HSAddress` = @Original_HSAddress) AND (`College` = @Original_Colle"& _ 
                "ge) AND (`CAddress` = @Original_CAddress) AND (`Encoder` = @Original_Encoder) AN"& _ 
                "D (`BirthDate` = @Original_BirthDate) AND (`AdmissionDate` = @Original_Admission"& _ 
                "Date) AND (`GraduationDate` = @Original_GraduationDate) AND (`Guardian` = @Origi"& _ 
                "nal_Guardian) AND (`GuardianContact` = @Original_GuardianContact) AND (`Guardian"& _ 
                "Address` = @Original_GuardianAddress) AND (`ImagePath` = @Original_ImagePath) AN"& _ 
                "D (`Course` = @Original_Course) AND (`Elementary` = @Original_Elementary) AND (`"& _ 
                "ElemAddress` = @Original_ElemAddress) AND (`GuardianRelationship` = @Original_Gu"& _ 
                "ardianRelationship) AND (`GuardianTelNo` = @Original_GuardianTelNo) AND (`EmailA"& _ 
                "ddress` = @Original_EmailAddress) AND (`Father` = @Original_Father) AND (`FOccup"& _ 
                "ation` = @Original_FOccupation) AND (`Mother` = @Original_Mother) AND (`MOccupat"& _ 
                "ion` = @Original_MOccupation) AND (`Age` = @Original_Age) AND (`Title` = @Origin"& _ 
                "al_Title) AND (`Pronoun` = @Original_Pronoun) AND (`Pronoun2` = @Original_Pronou"& _ 
                "n2) AND (`Pronoun3` = @Original_Pronoun3) AND (`Ethnicity` = @Original_Ethnicity"& _ 
                ") AND (`ParentsMonthly` = @Original_ParentsMonthly) AND (`Province` = @Original_"& _ 
                "Province) AND (`City` = @Original_City) AND (`Brgy` = @Original_Brgy) AND (`Siti"& _ 
                "o` = @Original_Sitio))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@Original_StudentNumber"
            ...
            Me._adapter.InsertCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `savhs`.`studeprofile` (`StudentNumber`, `FirstName`, `MiddleName`, `"& _ 
                "LastName`, `Sex`, `CivilStatus`, `BirthPlace`, `Citizenship`, `Religion`, `Blood"& _ 
                "Type`, `TelNumber`, `MobileNumber`, `HighSchool`, `HSAddress`, `College`, `CAddr"& _ 
                "ess`, `Requirements`, `Encoder`, `BirthDate`, `AdmissionDate`, `GraduationDate`,"& _ 
                " `Guardian`, `GuardianContact`, `GuardianAddress`, `ImagePath`, `Course`, `Eleme"& _ 
                "ntary`, `ElemAddress`, `GuardianRelationship`, `GuardianTelNo`, `EmailAddress`, "& _ 
                "`Father`, `FOccupation`, `Mother`, `MOccupation`, `Age`, `Title`, `Pronoun`, `Pr"& _ 
                "onoun2`, `Pronoun3`, `Ethnicity`, `ParentsMonthly`, `Province`, `City`, `Brgy`, "& _ 
                "`Sitio`) VALUES (@StudentNumber, @FirstName, @MiddleName, @LastName, @Sex, @Civi"& _ 
                "lStatus, @BirthPlace, @Citizenship, @Religion, @BloodType, @TelNumber, @MobileNu"& _ 
                "mber, @HighSchool, @HSAddress, @College, @CAddress, @Requirements, @Encoder, @Bi"& _ 
                "rthDate, @AdmissionDate, @GraduationDate, @Guardian, @GuardianContact, @Guardian"& _ 
                "Address, @ImagePath, @Course, @Elementary, @ElemAddress, @GuardianRelationship, "& _ 
                "@GuardianTelNo, @EmailAddress, @Father, @FOccupation, @Mother, @MOccupation, @Ag"& _ 
                "e, @Title, @Pronoun, @Pronoun2, @Pronoun3, @Ethnicity, @ParentsMonthly, @Provinc"& _ 
                "e, @City, @Brgy, @Sitio)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@StudentNumber"
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `savhs`.`studeprofile` SET `StudentNumber` = @StudentNumber, `FirstName` ="& _ 
                " @FirstName, `MiddleName` = @MiddleName, `LastName` = @LastName, `Sex` = @Sex, `"& _ 
                "CivilStatus` = @CivilStatus, `BirthPlace` = @BirthPlace, `Citizenship` = @Citize"& _ 
                "nship, `Religion` = @Religion, `BloodType` = @BloodType, `TelNumber` = @TelNumbe"& _ 
                "r, `MobileNumber` = @MobileNumber, `HighSchool` = @HighSchool, `HSAddress` = @HS"& _ 
                "Address, `College` = @College, `CAddress` = @CAddress, `Requirements` = @Require"& _ 
                "ments, `Encoder` = @Encoder, `BirthDate` = @BirthDate, `AdmissionDate` = @Admiss"& _ 
                "ionDate, `GraduationDate` = @GraduationDate, `Guardian` = @Guardian, `GuardianCo"& _ 
                "ntact` = @GuardianContact, `GuardianAddress` = @GuardianAddress, `ImagePath` = @"& _ 
                "ImagePath, `Course` = @Course, `Elementary` = @Elementary, `ElemAddress` = @Elem"& _ 
                "Address, `GuardianRelationship` = @GuardianRelationship, `GuardianTelNo` = @Guar"& _ 
                "dianTelNo, `EmailAddress` = @EmailAddress, `Father` = @Father, `FOccupation` = @"& _ 
                "FOccupation, `Mother` = @Mother, `MOccupation` = @MOccupation, `Age` = @Age, `Ti"& _ 
                "tle` = @Title, `Pronoun` = @Pronoun, `Pronoun2` = @Pronoun2, `Pronoun3` = @Prono"& _ 
                "un3, `Ethnicity` = @Ethnicity, `ParentsMonthly` = @ParentsMonthly, `Province` = "& _ 
                "@Province, `City` = @City, `Brgy` = @Brgy, `Sitio` = @Sitio WHERE ((`StudentNumb"& _ 
                "er` = @Original_StudentNumber) AND ((@IsNull_FirstName = 1 AND `FirstName` IS NU"& _ 
                "LL) OR (`FirstName` = @Original_FirstName)) AND ((@IsNull_MiddleName = 1 AND `Mi"& _ 
                "ddleName` IS NULL) OR (`MiddleName` = @Original_MiddleName)) AND ((@IsNull_LastN"& _ 
                "ame = 1 AND `LastName` IS NULL) OR (`LastName` = @Original_LastName)) AND (`Sex`"& _ 
                " = @Original_Sex) AND (`CivilStatus` = @Original_CivilStatus) AND (`BirthPlace` "& _ 
                "= @Original_BirthPlace) AND (`Citizenship` = @Original_Citizenship) AND (`Religi"& _ 
                "on` = @Original_Religion) AND (`BloodType` = @Original_BloodType) AND (`TelNumbe"& _ 
                "r` = @Original_TelNumber) AND (`MobileNumber` = @Original_MobileNumber) AND (`Hi"& _ 
                "ghSchool` = @Original_HighSchool) AND (`HSAddress` = @Original_HSAddress) AND (`"& _ 
                "College` = @Original_College) AND (`CAddress` = @Original_CAddress) AND (`Encode"& _ 
                "r` = @Original_Encoder) AND (`BirthDate` = @Original_BirthDate) AND (`AdmissionD"& _ 
                "ate` = @Original_AdmissionDate) AND (`GraduationDate` = @Original_GraduationDate"& _ 
                ") AND (`Guardian` = @Original_Guardian) AND (`GuardianContact` = @Original_Guard"& _ 
                "ianContact) AND (`GuardianAddress` = @Original_GuardianAddress) AND (`ImagePath`"& _ 
                " = @Original_ImagePath) AND (`Course` = @Original_Course) AND (`Elementary` = @O"& _ 
                "riginal_Elementary) AND (`ElemAddress` = @Original_ElemAddress) AND (`GuardianRe"& _ 
                "lationship` = @Original_GuardianRelationship) AND (`GuardianTelNo` = @Original_G"& _ 
                "uardianTelNo) AND (`EmailAddress` = @Original_EmailAddress) AND (`Father` = @Ori"& _ 
                "ginal_Father) AND (`FOccupation` = @Original_FOccupation) AND (`Mother` = @Origi"& _ 
                "nal_Mother) AND (`MOccupation` = @Original_MOccupation) AND (`Age` = @Original_A"& _ 
                "ge) AND (`Title` = @Original_Title) AND (`Pronoun` = @Original_Pronoun) AND (`Pr"& _ 
                "onoun2` = @Original_Pronoun2) AND (`Pronoun3` = @Original_Pronoun3) AND (`Ethnic"& _ 
                "ity` = @Original_Ethnicity) AND (`ParentsMonthly` = @Original_ParentsMonthly) AN"& _ 
                "D (`Province` = @Original_Province) AND (`City` = @Original_City) AND (`Brgy` = "& _ 
                "@Original_Brgy) AND (`Sitio` = @Original_Sitio))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@StudentNumber"
            param.DbType = Global.System.Data.DbType.[String]
    ...
    Partial Public Class incomestatementTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `savhs`.`incomestatement` WHERE ((`isID` = @Original_isID) AND (`Date"& _ 
                "From` = @Original_DateFrom) AND (`DateTo` = @Original_DateTo) AND (`StudeAccts` "& _ 
                "= @Original_StudeAccts) AND (`Expenses` = @Original_Expenses) AND (`NetIncome` ="& _ 
                " @Original_NetIncome))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.InsertCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `savhs`.`incomestatement` (`DateFrom`, `DateTo`, `StudeAccts`, `Expen"& _ 
                "ses`, `NetIncome`) VALUES (@DateFrom, @DateTo, @StudeAccts, @Expenses, @NetIncom"& _ 
                "e)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `savhs`.`incomestatement` SET `DateFrom` = @DateFrom, `DateTo` = @DateTo, "& _ 
                "`StudeAccts` = @StudeAccts, `Expenses` = @Expenses, `NetIncome` = @NetIncome WHE"& _ 
                "RE ((`isID` = @Original_isID) AND (`DateFrom` = @Original_DateFrom) AND (`DateTo"& _ 
                "` = @Original_DateTo) AND (`StudeAccts` = @Original_StudeAccts) AND (`Expenses` "& _ 
                "= @Original_Expenses) AND (`NetIncome` = @Original_NetIncome))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@DateFrom"
            param.DbType = Global.System.Data.DbType.[Date]
    ...
    Partial Public Class promissoryNotesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `savhs`.`promissory` WHERE ((`promissoryID` = @Original_promissoryID)"& _ 
                " AND (`DateApplied` = @Original_DateApplied) AND (`StudentNumber` = @Original_St"& _ 
                "udentNumber) AND (`Guardian` = @Original_Guardian) AND (`Amount` = @Original_Amo"& _ 
                "unt) AND (`PromisedDate` = @Original_PromisedDate) AND (`Status` = @Original_Sta"& _ 
                "tus) AND (`Sem` = @Original_Sem) AND (`SY` = @Original_SY))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `savhs`.`promissory` SET `DateApplied` = @DateApplied, `StudentNumber` = @"& _ 
                "StudentNumber, `Guardian` = @Guardian, `Amount` = @Amount, `PromisedDate` = @Pro"& _ 
                "misedDate, `Status` = @Status, `Sem` = @Sem, `SY` = @SY WHERE ((`promissoryID` ="& _ 
                " @Original_promissoryID) AND (`DateApplied` = @Original_DateApplied) AND (`Stude"& _ 
                "ntNumber` = @Original_StudentNumber) AND (`Guardian` = @Original_Guardian) AND ("& _ 
                "`Amount` = @Original_Amount) AND (`PromisedDate` = @Original_PromisedDate) AND ("& _ 
                "`Status` = @Original_Status) AND (`Sem` = @Original_Sem) AND (`SY` = @Original_S"& _ 
                "Y))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
    ...
    Partial Public Class companyTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `savhs`.`company` WHERE ((`compID` = @Original_compID) AND (`Company`"& _ 
                " = @Original_Company) AND (`Address1` = @Original_Address1) AND (`Address2` = @O"& _ 
                "riginal_Address2) AND (`TelNo` = @Original_TelNo) AND (`Website` = @Original_Web"& _ 
                "site) AND (`Email` = @Original_Email))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.InsertCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `savhs`.`company` (`Company`, `Address1`, `Address2`, `TelNo`, `Websi"& _ 
                "te`, `Email`) VALUES (@Company, @Address1, @Address2, @TelNo, @Website, @Email)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `savhs`.`company` SET `Company` = @Company, `Address1` = @Address1, `Addre"& _ 
                "ss2` = @Address2, `TelNo` = @TelNo, `Website` = @Website, `Email` = @Email WHERE"& _ 
                " ((`compID` = @Original_compID) AND (`Company` = @Original_Company) AND (`Addres"& _ 
                "s1` = @Original_Address1) AND (`Address2` = @Original_Address2) AND (`TelNo` = @"& _ 
                "Original_TelNo) AND (`Website` = @Original_Website) AND (`Email` = @Original_Ema"& _ 
                "il))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@Company"
    ...
    Partial Public Class SchedulesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `savhs`.`semsubjects` WHERE ((`subjectid` = @Original_subjectid) AND "& _ 
                "(`SubjectCode` = @Original_SubjectCode) AND ((@IsNull_Description = 1 AND `Descr"& _ 
                "iption` IS NULL) OR (`Description` = @Original_Description)) AND ((@IsNull_LecUn"& _ 
                "it = 1 AND `LecUnit` IS NULL) OR (`LecUnit` = @Original_LecUnit)) AND ((@IsNull_"& _ 
                "LabUnit = 1 AND `LabUnit` IS NULL) OR (`LabUnit` = @Original_LabUnit)) AND ((@Is"& _ 
                "Null_Section = 1 AND `Section` IS NULL) OR (`Section` = @Original_Section)) AND "& _ 
                "((@IsNull_LabTime = 1 AND `LabTime` IS NULL) OR (`LabTime` = @Original_LabTime))"& _ 
                " AND ((@IsNull_SchedTime = 1 AND `SchedTime` IS NULL) OR (`SchedTime` = @Origina"& _ 
                "l_SchedTime)) AND ((@IsNull_Room = 1 AND `Room` IS NULL) OR (`Room` = @Original_"& _ 
                "Room)) AND ((@IsNull_Slot = 1 AND `Slot` IS NULL) OR (`Slot` = @Original_Slot)) "& _ 
                "AND (`IDNumber` = @Original_IDNumber) AND ((@IsNull_SY = 1 AND `SY` IS NULL) OR "& _ 
                "(`SY` = @Original_SY)) AND ((@IsNull_Semester = 1 AND `Semester` IS NULL) OR (`S"& _ 
                "emester` = @Original_Semester)) AND ((@IsNull_Instructor = 1 AND `Instructor` IS"& _ 
                " NULL) OR (`Instructor` = @Original_Instructor)) AND ((@IsNull_Time1 = 1 AND `Ti"& _ 
                "me1` IS NULL) OR (`Time1` = @Original_Time1)) AND ((@IsNull_AM1 = 1 AND `AM1` IS"& _ 
                " NULL) OR (`AM1` = @Original_AM1)) AND ((@IsNull_Time2 = 1 AND `Time2` IS NULL) "& _ 
                "OR (`Time2` = @Original_Time2)) AND ((@IsNull_AM2 = 1 AND `AM2` IS NULL) OR (`AM"& _ 
                "2` = @Original_AM2)) AND ((@IsNull_Time3 = 1 AND `Time3` IS NULL) OR (`Time3` = "& _ 
                "@Original_Time3)) AND ((@IsNull_AM3 = 1 AND `AM3` IS NULL) OR (`AM3` = @Original"& _ 
                "_AM3)) AND (`Time4` = @Original_Time4) AND (`AM4` = @Original_AM4) AND (`Days1` "& _ 
                "= @Original_Days1) AND (`Days2` = @Original_Days2) AND (`Course` = @Original_Cou"& _ 
                "rse) AND (`YearLevel` = @Original_YearLevel) AND (`SubjectStatus` = @Original_Su"& _ 
                "bjectStatus))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.InsertCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `savhs`.`semsubjects` (`SubjectCode`, `Description`, `LecUnit`, `LabU"& _ 
                "nit`, `Section`, `LabTime`, `SchedTime`, `Room`, `Slot`, `IDNumber`, `SY`, `Seme"& _ 
                "ster`, `Instructor`, `Time1`, `AM1`, `Time2`, `AM2`, `Time3`, `AM3`, `Time4`, `A"& _ 
                "M4`, `Days1`, `Days2`, `Course`, `YearLevel`, `SubjectStatus`) VALUES (@SubjectC"& _ 
                "ode, @Description, @LecUnit, @LabUnit, @Section, @LabTime, @SchedTime, @Room, @S"& _ 
                "lot, @IDNumber, @SY, @Semester, @Instructor, @Time1, @AM1, @Time2, @AM2, @Time3,"& _ 
                " @AM3, @Time4, @AM4, @Days1, @Days2, @Course, @YearLevel, @SubjectStatus)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `savhs`.`semsubjects` SET `SubjectCode` = @SubjectCode, `Description` = @D"& _ 
                "escription, `LecUnit` = @LecUnit, `LabUnit` = @LabUnit, `Section` = @Section, `L"& _ 
                "abTime` = @LabTime, `SchedTime` = @SchedTime, `Room` = @Room, `Slot` = @Slot, `I"& _ 
                "DNumber` = @IDNumber, `SY` = @SY, `Semester` = @Semester, `Instructor` = @Instru"& _ 
                "ctor, `Time1` = @Time1, `AM1` = @AM1, `Time2` = @Time2, `AM2` = @AM2, `Time3` = "& _ 
                "@Time3, `AM3` = @AM3, `Time4` = @Time4, `AM4` = @AM4, `Days1` = @Days1, `Days2` "& _ 
                "= @Days2, `Course` = @Course, `YearLevel` = @YearLevel, `SubjectStatus` = @Subje"& _ 
                "ctStatus WHERE ((`subjectid` = @Original_subjectid) AND (`SubjectCode` = @Origin"& _ 
                "al_SubjectCode) AND ((@IsNull_Description = 1 AND `Description` IS NULL) OR (`De"& _ 
                "scription` = @Original_Description)) AND ((@IsNull_LecUnit = 1 AND `LecUnit` IS "& _ 
                "NULL) OR (`LecUnit` = @Original_LecUnit)) AND ((@IsNull_LabUnit = 1 AND `LabUnit"& _ 
                "` IS NULL) OR (`LabUnit` = @Original_LabUnit)) AND ((@IsNull_Section = 1 AND `Se"& _ 
                "ction` IS NULL) OR (`Section` = @Original_Section)) AND ((@IsNull_LabTime = 1 AN"& _ 
                "D `LabTime` IS NULL) OR (`LabTime` = @Original_LabTime)) AND ((@IsNull_SchedTime"& _ 
                " = 1 AND `SchedTime` IS NULL) OR (`SchedTime` = @Original_SchedTime)) AND ((@IsN"& _ 
                "ull_Room = 1 AND `Room` IS NULL) OR (`Room` = @Original_Room)) AND ((@IsNull_Slo"& _ 
                "t = 1 AND `Slot` IS NULL) OR (`Slot` = @Original_Slot)) AND (`IDNumber` = @Origi"& _ 
                "nal_IDNumber) AND ((@IsNull_SY = 1 AND `SY` IS NULL) OR (`SY` = @Original_SY)) A"& _ 
                "ND ((@IsNull_Semester = 1 AND `Semester` IS NULL) OR (`Semester` = @Original_Sem"& _ 
                "ester)) AND ((@IsNull_Instructor = 1 AND `Instructor` IS NULL) OR (`Instructor` "& _ 
                "= @Original_Instructor)) AND ((@IsNull_Time1 = 1 AND `Time1` IS NULL) OR (`Time1"& _ 
                "` = @Original_Time1)) AND ((@IsNull_AM1 = 1 AND `AM1` IS NULL) OR (`AM1` = @Orig"& _ 
                "inal_AM1)) AND ((@IsNull_Time2 = 1 AND `Time2` IS NULL) OR (`Time2` = @Original_"& _ 
                "Time2)) AND ((@IsNull_AM2 = 1 AND `AM2` IS NULL) OR (`AM2` = @Original_AM2)) AND"& _ 
                " ((@IsNull_Time3 = 1 AND `Time3` IS NULL) OR (`Time3` = @Original_Time3)) AND (("& _ 
                "@IsNull_AM3 = 1 AND `AM3` IS NULL) OR (`AM3` = @Original_AM3)) AND (`Time4` = @O"& _ 
                "riginal_Time4) AND (`AM4` = @Original_AM4) AND (`Days1` = @Original_Days1) AND ("& _ 
                "`Days2` = @Original_Days2) AND (`Course` = @Original_Course) AND (`YearLevel` = "& _ 
                "@Original_YearLevel) AND (`SubjectStatus` = @Original_SubjectStatus))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@SubjectCode"
            param.DbType = Global.System.Data.DbType.[String]
