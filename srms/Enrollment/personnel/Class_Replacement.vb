...
Public Class Class_Replacement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.Class_Replacement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedClass_Replacement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Class_Replacement = New Class_Replacement
        rpt.Site = Me.Site
        Return rpt
    End Function
