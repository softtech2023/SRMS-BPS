...
Public Class TravelAuthority
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIMS.TravelAuthority.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTravelAuthority
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TravelAuthority = New TravelAuthority
        rpt.Site = Me.Site
        Return rpt
    End Function
