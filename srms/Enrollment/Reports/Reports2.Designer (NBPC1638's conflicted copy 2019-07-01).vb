...
Partial Public Class Reports2
    ...
    Partial Public Class goodmoralDataTable
        ...
        Public Overloads Function AddgoodmoralRow( _
                    ...
                    ByVal sHeadPosition As String) As goodmoralRow
            Dim rowgoodmoralRow As goodmoralRow = CType(Me.NewRow,goodmoralRow)
            Dim columnValuesArray() As Object = New Object() {semstudentid, Nothing, StudentName, Course, YearLevel, Semester, SY, LastName, Title, Pronoun, Pronoun2, Pronoun3, SchoolName, SchoolAddress, GuidanceJHS, SchoolHead, sHeadPosition}
    ...
    Partial Public Class DailystudeCollectionDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddDailystudeCollectionRow(ByVal StudentNumber As String, ByVal PDate As Date, ByVal ORNumber As String, ByVal Amount As Double, ByVal description As String, ByVal Payor As String, ByVal CheckNumber As String, ByVal Bank As String, ByVal ORStatus As String, ByVal Cashier As String, ByVal PaymentType As String, ByVal Course As String) As DailystudeCollectionRow
            Dim rowDailystudeCollectionRow As DailystudeCollectionRow = CType(Me.NewRow,DailystudeCollectionRow)
            Dim columnValuesArray() As Object = New Object() {StudentNumber, PDate, ORNumber, Amount, description, Payor, CheckNumber, Bank, ORStatus, Cashier, PaymentType, Course}
    ...
    Partial Public Class courseCollectionSummaryDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddcourseCollectionSummaryRow(ByVal Course As String, ByVal _sum_Amount_ As Double, ByVal PDate As Date, ByVal YearLevel As String) As courseCollectionSummaryRow
            Dim rowcourseCollectionSummaryRow As courseCollectionSummaryRow = CType(Me.NewRow,courseCollectionSummaryRow)
            Dim columnValuesArray() As Object = New Object() {Course, _sum_Amount_, PDate, YearLevel}
...
Namespace Reports2TableAdapters
    ...
    Partial Public Class goodmoralTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "select ss.semstudentid, ss.StudentNumber, concat(p.FirstName,' ',p.MiddleName,' '"& _ 
                ...
                "s, sr.GuidanceJHS, sr.SchoolHead, sr.sHeadPosition from semesterstude ss join st"& _ 
                "udeprofile p on ss.StudentNumber=p.StudentNumber join srms_settings sr on ss.set"& _ 
                "tingsID=sr.settingsID"
    ...
    Partial Public Class DailystudeCollectionTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT StudentNumber, concat(LastName,', ',FirstName) as Payor, Course,  PDate, O"& _ 
                "RNumber, Amount, description, CheckNumber, Bank, ORStatus, Cashier, PaymentType "& _ 
    ...
    Partial Public Class sectionsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`sections` WHERE ((`sectionID` = @Original_sectionID) AN"& _ 
                "D (`Section` = @Original_Section))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `deped_srms`.`sections` (`Section`) VALUES (@Section)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`sections` SET `Section` = @Section WHERE ((`sectionID` = @Or"& _ 
                "iginal_sectionID) AND (`Section` = @Original_Section))"
    ...
    Partial Public Class courseCollectionSummaryTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "select Course, sum(Amount), PDate, YearLevel from paymentsaccounts group by Cours"& _ 
                "e, PDate"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
    ...
    Partial Public Class calendarTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`calendar` WHERE ((`calendarID` = @Original_calendarID) "& _ 
                "AND (`DateFrom` = @Original_DateFrom) AND (`DateTo` = @Original_DateTo) AND (`Ti"& _ 
                "me` = @Original_Time) AND (`Event` = @Original_Event) AND (`Venue` = @Original_V"& _ 
                "enue) AND (`InCharge` = @Original_InCharge) AND (`SY` = @Original_SY))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.InsertCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `deped_srms`.`calendar` (`DateFrom`, `DateTo`, `Time`, `Event`, `Venu"& _ 
                "e`, `InCharge`, `SY`) VALUES (@DateFrom, @DateTo, @Time, @Event, @Venue, @InChar"& _ 
                "ge, @SY)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`calendar` SET `DateFrom` = @DateFrom, `DateTo` = @DateTo, `T"& _ 
                "ime` = @Time, `Event` = @Event, `Venue` = @Venue, `InCharge` = @InCharge, `SY` ="& _ 
                " @SY WHERE ((`calendarID` = @Original_calendarID) AND (`DateFrom` = @Original_Da"& _ 
                "teFrom) AND (`DateTo` = @Original_DateTo) AND (`Time` = @Original_Time) AND (`Ev"& _ 
                "ent` = @Original_Event) AND (`Venue` = @Original_Venue) AND (`InCharge` = @Origi"& _ 
                "nal_InCharge) AND (`SY` = @Original_SY))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@DateFrom"
            param.DbType = Global.System.Data.DbType.[Date]
    ...
    Partial Public Class roomsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `deped_srms`.`rooms` WHERE ((`roomID` = @Original_roomID) AND (`Room`"& _ 
                " = @Original_Room))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.InsertCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `deped_srms`.`rooms` (`Room`) VALUES (@Room)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            ...
            Me._adapter.UpdateCommand = New Global.MySql.Data.MySqlClient.MySqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `deped_srms`.`rooms` SET `Room` = @Room WHERE ((`roomID` = @Original_roomI"& _ 
                "D) AND (`Room` = @Original_Room))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            param = New Global.MySql.Data.MySqlClient.MySqlParameter
            param.ParameterName = "@Room"
            param.DbType = Global.System.Data.DbType.[String]
